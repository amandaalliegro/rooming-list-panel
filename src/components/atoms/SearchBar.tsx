...
const SearchBar = ({ onSearch }: { onSearch: (query: string) => void }) => {
  ...
  return (
    <div className="flex w-[210px] lg:w-[280px] h-[48px] px-0 pr-4 pl-1 items-center gap-[10px] rounded-[12px] border border-[#E4ECF2] bg-white">
      {/* Search Icon */}
      <svg
        className="w-10 h-10 flex-shrink-0 fill-page-bg stroke-[#E4ECF2] stroke-[1]"
      ...
      <input
        type="text"
        placeholder="Search"
        className="text-sm font-normal leading-[20px] text-muted-gray bg-transparent outline-none w-full"
